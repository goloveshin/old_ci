...
set(CONFIGURE_PARAMS_LIST
    ...
    "--with-libldap=${LIB__OPENLDAP__LIBRARY_DIR}"

    #   --with-ldap-includes=DIR    Path to the libldap include files /usr/local/include
    "--with-ldap-includes=${LIB__OPENLDAP__INCLUDE_DIR}"
    ...
    "LIBS=-lssl -lcrypto -lsasl2 ${ANDROID_STL_ALL_LIBRARIES_WITH_l} -L${ANDROID_STL_LIBRARIES_PATH} -lm"
)
